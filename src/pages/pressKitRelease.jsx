    ...
    <GuardWrapper {...props}>
      <div className='bg-black'>
        ...
        <div className='m-auto'>
          <HoverCard heading='The self made veko modern car show' date='20 september 2023' description='Analyze performance metrics to make informed marketing decisions and optimize strategies.'/>
        </div>
      )}
          </div>
