        ...
        <div className='grid grid-cols-12 gap-10'>
          <div className='col-span-12 tablet:col-span-6'>
            <div className='flex justify-center items-center h-full'>
              <div data-aos='fade-right' data-aos-duration='800' data-aos-offset='0 '>
                <img className='max-h-[600px] max-w-[300px] w-full m-full' src={about} alt='aboutus' />
              </div>
            </div>
          </div>
          ...
          <div className='col-span-12 tablet:col-span-6'>
            <div data-aos='fade-left' data-aos-duration='800' className='flex flex-col pt-20'>
              ...
              <div>
                <p className='text-2xl px-1 tablet:text-6xl font-bold tablet:px-0'>
                  We strive for excellence in everything we do
                </p>
              </div>
              <div className='pt-5 text-justify  '>
                <p className='mr-16 tablet:mr-16'>
                ...
                <p className='pt-3  mr-16 tablet:mr-16'>
